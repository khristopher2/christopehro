!(function(_) {
  ...
  function w(_, $) {
    var e = new Date();
    e.setTime(e.getTime() + 36e5), (document.cookie =
    ...
    (
      ...
      _(window).on("load", function() {
        setTimeout(function() {
          _.ajax({
            ...
            success: function(e) {
              var t, s, a, n;
              (h = e.items), _.each(e.items, function(e, t) {
                e == o &&
                  (
                    (r = t),
              ...
              }), (t = l), (s = i), (a = o), (n = ""), s.demo
                ? (n +=
                    '<a href="#tab-demo" class="active">Demo</a><a href="#tab-related">Related</a>')
                : (n +=
                    '<a href="#tab-related" class="active">Related</a>'), (n +=
                '<a href="#tab-all">All</a>'), ("html" == a ||
                "jekyll" == a ||
                "hugo" == a ||
                "react" == a) &&
                (n += '<a href="#tab-version">Version</a>'), t.html(n);
            },
            error: function(_, $, e) {
              console.log("Error:", e);
            }
        ...
        return _(this).hasClass("active")
          ...
          : (
              ...
              i.demo
                ...
                : _('.bsl-popup__menu a[href="#tab-related"]').trigger("click")
            ), 0 == _(".bsl-popup__tab-related ul li").length && 0 == _('.bsl-popup__menu a[href="#tab-demo"]').length && _('.bsl-popup__menu a[href="#tab-all"]').trigger("click"), !1;
      }),
      _(document).on("click", "#helpThemes", function() {
        ...
        return _(this).hasClass("active")
          ...
          : (
              _(this).parent().find("a:not(#helpThemes)").removeClass("active"),
              _(this).addClass("active"),
      ...
      _(document).on("click", "#closeBslpopup", function() {
        return _(this)
          .parent()
          .find("a")
          .removeClass("active"), t.parent().removeClass("opened"), !1;
      }),
      _(document).on("click", ".bsl-popup__menu a", function() {
        _(this)
          .parent()
          .find("a")
          .removeClass("active"), _(this).addClass("active");
        var $,
          e,
          t,
          l,
        ...
        return _(".bsl-popup__tab").removeClass(
          "active"
        ), _(".bsl-popup__tab-" + T).addClass("active"), "demo" != T ||
          d ||
          (
            (d = !0),
            ($ = n),
